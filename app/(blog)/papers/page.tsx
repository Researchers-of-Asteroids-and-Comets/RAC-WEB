    ...
    <div className="container mx-auto p-5">
      <div className="mb-12 border-b border-neutral-800 pb-8">
        ...
        <p className="text-lg text-neutral-400 max-w-2xl">
          COLLECTION OF PUBLICATIONS AND CONTRIBUTIONS
        </p>
      </div>
          ...
          papers.map((paper: Paper) => (
            ...
            >
              <div className="flex-1 space-y-4">
                ...
                <h2 className="text-xl md:text-2xl font-bold leading-tight transition-colors uppercase">
                  {paper.paperUrl ? (
                    <a
                      href={paper.paperUrl}
                      target="_blank"
                ...
                <div className="flex flex-wrap gap-2 text-xs font-mono text-neutral-400">
                  ...
                  {paper.authors?.map((author: string, index: number) => (
                    <span
                      key={index}
                      className="text-white bg-neutral-900 px-1"
                    >
                      {author}
                    </span>
                  ))}
              ...
              <div className="pt-6 mt-6 border-t border-neutral-900 flex flex-wrap gap-4 text-xs font-mono uppercase">
                {paper.paperUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-blue-500 hover:underline decoration-1 underline-offset-4"
                  >
                    VIEW SOURCE
                  </a>
                )}
